...
import { fetchSenate, fetchLoyalists, fetchMavericks } from '../actions/senate'
...
export default connect(mapStateToProps, { fetchSenate, fetchLoyalists, fetchMavericks })(SenatorsList)
